...
const AuthContainer = ({ children }) => {
  return (
    <div className='w-screen lg:h-screen flex flex-col lg:flex-row roboto-bold text-white' style={{backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
      <div className='lg:w-1/2 w-full h-full flex items-center justify-center gap-10 p-10 bg-black bg-opacity-50 text-white font-bold'>
        <div className='flex flex-col gap-4 items-center lg:items-start'>
          ...
          <h1 className='text-4xl roboto-medium'>Any job. Anywhere. Anytime.</h1>
        </div>
      </div>
